...
from tasks import LinearFATileCoding3456BalanceTaskRewardPower7
from training import LinearFATraining
from learners import SARSALambda_LinFA_ReplacingTraces

task = LinearFATileCoding3456BalanceTaskRewardPower7()
...
tr = LinearFATraining('balance_sarsalambda_linfa_replacetrace_anneal_RewardPower7_take4', experiment,
