...
from tasks import LinearFATileCoding3456BalanceTaskRewardPower6
from training import LinearFATraining
from learners import SARSALambda_LinFA_ReplacingTraces

task = LinearFATileCoding3456BalanceTaskRewardPower6()
...
tr = LinearFATraining('balance_sarsalambda_linfa_replacetrace_anneal_RewardPower6_take1', experiment,
