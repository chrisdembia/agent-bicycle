...
from tasks import Proportional3456ControlBalanceTask
from training import LinearFATraining
from learners import SARSALambda_LinFA_ReplacingTraces

task = Proportional3456ControlBalanceTask()
...
tr = LinearFATraining('propbalance_sarsalambda_linfa_replacetrace_anneal', experiment,
