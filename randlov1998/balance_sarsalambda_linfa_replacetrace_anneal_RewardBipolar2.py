...
from tasks import LinearFATileCoding3456BalanceTaskRewardBipolar2
from training import LinearFATraining
from learners import SARSALambda_LinFA_ReplacingTraces

task = LinearFATileCoding3456BalanceTaskRewardBipolar2()
...
tr = LinearFATraining('balance_sarsalambda_linfa_replacetrace_anneal_RewardBipolar2_take1', experiment,
