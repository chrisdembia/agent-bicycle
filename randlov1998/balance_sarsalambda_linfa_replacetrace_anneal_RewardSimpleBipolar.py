...
from tasks_old import LinearFATileCoding3456BalanceTaskRewardSimpleBipolar
from training import LinearFATraining
from learners import SARSALambda_LinFA_ReplacingTraces

task = LinearFATileCoding3456BalanceTaskRewardSimpleBipolar()
...
tr = LinearFATraining('balance_sarsalambda_linfa_replacetrace_anneal_RewardSimpleBipolar_take17', experiment,
